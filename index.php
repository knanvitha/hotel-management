...
<body>
    <div class="container">
       ...
       <img class="img-responsive" src="images/palm.jpg" style="width:100%; height:250px;">      
        ...
        <div class="w3-content w3-section">
            <img class="mySlides w3-animate-fading" src="images/carousel1.jpg" style="width:100%; height:450px;">
            <img class="mySlides w3-animate-fading" src="images/carousel2.jpeg" style="width:100%; height:450px;">
            <img class="mySlides w3-animate-fading" src="images/carousel3.webp" style="width:100%; height:450px;">
            <img class="mySlides w3-animate-fading" src="images/carousel4.jpg" style="width:100%; height:450px;">
            <img class="mySlides w3-animate-fading" src="images/carousel6.jpg" style="width:100%; height:450px;">
        </div>    
        </div>
        <hr>
        ...
        <div class="row" style="color: #ffbb2b">
            <div class="col-md-12 wellfix" style="text-align:center">
              <h4><strong>Contact Us</strong></h4><hr>
              Address :The Palms hotel & resort,Goa<br>
              Mail : thepalms@gmail.com <br>
            </div>
        </div>
